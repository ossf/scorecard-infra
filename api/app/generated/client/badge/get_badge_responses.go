...
func (o *GetBadgeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the get badge found response
func (o *GetBadgeFound) Code() int {
	return 302
}
...
func (o *GetBadgeDefault) Error() string {
	...
	return fmt.Sprintf("[GET /projects/{platform}/{org}/{repo}/badge][%d] getBadge default %s", o._statusCode, payload)
}
