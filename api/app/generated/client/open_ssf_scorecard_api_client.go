...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *OpenSSFScorecardAPI {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *OpenSSFScorecardAPI) SetTransport(transport runtime.ContextualTransport) {
