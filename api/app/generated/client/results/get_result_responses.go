...
func (o *GetResultReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetResultOK) Error() string {
	...
	return fmt.Sprintf("[GET /projects/{platform}/{org}/{repo}][%d] getResultOK %s", 200, payload)
}
...
func (o *GetResultBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{platform}/{org}/{repo}][%d] getResultBadRequest %s", 400, payload)
}
...
func (o *GetResultDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{platform}/{org}/{repo}][%d] getResult default %s", o._statusCode, payload)
}
