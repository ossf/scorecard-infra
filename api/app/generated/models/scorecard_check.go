...
func (m *ScorecardCheckDocumentation) Validate(_ strfmt.Registry) error {
	return nil
}

// ContextValidate validates this scorecard check documentation based on context it is used
func (m *ScorecardCheckDocumentation) ContextValidate(_ context.Context, _ strfmt.Registry) error {
	return nil
}
