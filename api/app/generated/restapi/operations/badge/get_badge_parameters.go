...
// validateStyle carries out validations for parameter Style
func (o *GetBadgeParams) validateStyle(formats strfmt.Registry) error {

	if err := validate.EnumCase("style", "query", *o.Style, []any{"plastic", "flat", "flat-square", "for-the-badge", "social"}, true); err != nil {
		return err
	}
